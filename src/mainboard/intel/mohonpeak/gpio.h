...
const struct soc_gpio soc_gpio_mode = {
	.gpio0 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio4 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio5 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio10 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio13 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio14 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio15 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio16 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio17 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio18 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio27 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio28 = GPIO_MODE_GPIO, /* Board ID GPIO */
	//.gpio29 = GPIO_MODE_GPIO, /* Board ID GPIO */
};

const struct soc_gpio soc_gpio_direction = {
	.gpio0 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio14 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio15 = GPIO_DIR_INPUT, /* Board ID GPIO */
};

const struct soc_gpio soc_gpio_level = {
	.gpio4 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio5 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio10 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio13 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio16 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio17 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio18 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio27 = GPIO_LEVEL_HIGH, /* Board ID GPIO */
	.gpio28 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	//.gpio29 = GPIO_LEVEL_HIGH, /* Board ID GPIO */
};
...
const struct soc_gpio soc_gpio_sus_mode  = {
	.gpio0 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio1 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio6 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio7 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio8 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio17 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio18 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio19 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio20 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio21 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio22 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio26 = GPIO_MODE_GPIO, /* Board ID GPIO */
	.gpio27 = GPIO_MODE_GPIO, /* Board ID GPIO */
};

const struct soc_gpio soc_gpio_sus_direction = {
	.gpio6 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio19 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio20 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio21 = GPIO_DIR_INPUT, /* Board ID GPIO */
	.gpio22 = GPIO_DIR_INPUT, /* Board ID GPIO */
};

const struct soc_gpio soc_gpio_sus_level = {
	.gpio0 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio1 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio7 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio8 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio17 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio18 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio26 = GPIO_LEVEL_LOW, /* Board ID GPIO */
	.gpio27 = GPIO_LEVEL_LOW, /* Board ID GPIO */
};
